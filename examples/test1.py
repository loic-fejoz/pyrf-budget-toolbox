...
tr_switch = Element(name="TR_Switch", gain=-1.3, nf=2.3, oip3=37)
...
a1 = Amplifier(name="LNA", gain=15 - insertion_loss, nf=1.5, oip3=26, z_in=Z)
...
a3 = Amplifier(name="IF_Amp", gain=40 - insertion_loss, nf=2.5, oip3=37, z_in=Z)
